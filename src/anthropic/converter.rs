...
mod tests {
    ...
    #[test]
    fn test_convert_request_uses_sonnet_5_upstream_model_id() {
        let req = MessagesRequest {
            model: "claude-sonnet-5-thinking".to_string(),
            max_tokens: 32,
